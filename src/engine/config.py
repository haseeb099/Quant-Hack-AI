...
class QuantAIConfig:
    ...
    def agent_config(self, name: str) -> dict[str, Any]:
        base = dict(self.agents.get(name, {}))
        overrides = self.phase_rules.get("agent_overrides", {}).get(name, {})
        if overrides:
    ...
    def phase_rules(self) -> dict[str, Any]:
        ...
        defaults: dict[str, dict[str, Any]] = {
            "round1": {
                ...
                "symbol_cooldown_minutes": 8,
                "win_cooldown_minutes": 3,
                "loss_cooldown_minutes": 12,
                "sharpe_guard_enabled": False,
            ...
            "round3": {
                ...
                "time_stop_bars": 20,
                "time_stop_m15_bars": 20,
                "time_stop_min_r": 0.25,
                "partial_take_r": 1.5,
                "partial_fraction": 0.25,
                "breakeven_r": 0.75,
                "max_adverse_r": -0.65,
                "adverse_stop_m15_bars": 3,
                "adverse_stop_r": -0.30,
                "never_green_bars": 3,
                ...
                "max_new_entries_per_cycle": 3,
                "min_consensus_agents": 2,
                "symbol_cooldown_minutes": 6,
                "win_cooldown_minutes": 3,
                "loss_cooldown_minutes": 12,
                "cycle_minutes": 3,
                "sharpe_guard_enabled": True,
                "sharpe_guard_min_r_to_close": -0.5,
                "min_orchestrator_size_scale": 0.95,
            ...
            "finals": {
                ...
                "never_green_bars": 4,
                "never_green_peak_r": 0.05,
                "never_green_max_r": -0.12,
                "max_new_entries_per_cycle": 6,
                "min_consensus_agents": 1,
                "symbol_cooldown_minutes": 8,
                "win_cooldown_minutes": 3,
                "loss_cooldown_minutes": 12,
                "cycle_minutes": 2,
                "sharpe_guard_enabled": True,
                "sharpe_guard_min_r_to_close": -0.5,
                "min_orchestrator_size_scale": 1.10,
                "net_directional_enforce_min_gross_pct": 0.10,
                "blocked_symbols": ["XRP/USD", "BAR/USD", "EUR/GBP", "USD/CHF", "USD/JPY"],
            },
        }
